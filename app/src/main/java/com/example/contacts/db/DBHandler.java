...
public class DBHandler  extends SQLiteOpenHelper {
    ...
    private static final String PHONE = "tracks";
    ...
    public void addNewCourse(String courseName, String courseDuration, String courseDescription, String courseTracks) {
        ...
        values.put(DATE_CREATED, courseDuration);
        values.put(OTP, courseDescription);
        values.put(PHONE, courseTracks);
    ...
    public ArrayList<CourseModal> readCourses()
    {
        ...
        Cursor cursorCourses
                = db.rawQuery("SELECT * FROM " + TABLE_NAME + " ORDER BY " + ID_COL + " DESC",null);
